...
class BwaIndexCommandline(AbstractCommandline):
    ...
    >>> from SAP.Bio.Sequencing.Applications import BwaIndexCommandline
...
class BwaAlignCommandline(AbstractCommandline):
    ...
    >>> from SAP.Bio.Sequencing.Applications import BwaAlignCommandline
    >>> reference_genome = "/path/to/reference_genome.fasta"
...
class BwaSamseCommandline(AbstractCommandline):
    ...
    >>> from SAP.Bio.Sequencing.Applications import BwaSamseCommandline
    >>> reference_genome = "/path/to/reference_genome.fasta"
    >>> read_file = "/path/to/read_1.fq"
...
class BwaSampeCommandline(AbstractCommandline):
    ...
    >>> from SAP.Bio.Sequencing.Applications import BwaSampeCommandline
    >>> reference_genome = "/path/to/reference_genome.fasta"
...
class BwaBwaswCommandline(AbstractCommandline):
    ...
    >>> from SAP.Bio.Sequencing.Applications import BwaBwaswCommandline
    >>> reference_genome = "/path/to/reference_genome.fasta"
    >>> read_file = "/path/to/read_1.fq"
