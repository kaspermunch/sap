...
from SAP.Bio.CodonAlign.CodonSeq import _get_codon_list, CodonSeq, cal_dn_ds
from SAP.Bio.CodonAlign.chisq import chisqprob
...
class CodonAlignment(MultipleSeqAlignment):
    ...
    def get_dn_ds_matrix(self, method="NG86"):
        ...
        """
        from SAP.Bio.Phylo.TreeConstruction import _DistanceMatrix as DM
    ...
    def get_dn_ds_tree(self, dn_ds_method="NG86", tree_method="UPGMA"):
        ...
        """
        from SAP.Bio.Phylo.TreeConstruction import DistanceTreeConstructor
