...
#                                           'MapToPreAligned = SAP.Alignment.MapToPreAligned',
                       ...
                       'sap.assignment': [ 'Barcoder = SAP.Assignment.Barcoder',
                                         ...
                                         'IMa = SAP.Assignment.IMa' ], # MAYBE IS SHOULD BE A NEW KIND OF SAP.POSTANALYSIS PLUGIN 
                       },
      ext_modules=[Extension('SAP.Assignment.Barcoder._Barcoder', # Has to be prefixed with the underscore because this is the name generated by swig.
                   ...
                   Extension('SAP.PostAnalysis.IMa._IMa', # Has to be prefixed with the underscore because this is the name generated by swig.
                             ...
                             #glob.glob('ext/ima/*.c') + ['ext/ima/ima/src/build_gtree.c', 'ext/ima/ima/src/build_poptree.c', 'ext/ima/ima/src/calc_prob_data.c', 'ext/ima/ima/src/ginfo.c', 'ext/ima/ima/src/ima_main.c', 'ext/ima/ima/src/initialize.c', 'ext/ima/ima/src/mcmcfile.c', 'ext/ima/ima/src/multi_t_bins.c', 'ext/ima/ima/src/output.c', 'ext/ima/ima/src/readata.c', 'ext/ima/ima/src/surface_call_functions.c', 'ext/ima/ima/src/surface_search_functions.c', 'ext/ima/ima/src/swapchains.c', 'ext/ima/ima/src/treeprint.c', 'ext/ima/ima/src/update_gtree.c', 'ext/ima/ima/src/update_gtree_common.c', 'ext/ima/ima/src/update_gtree_covar.c', 'ext/ima/ima/src/update_mc_params.c', 'ext/ima/ima/src/update_t_NW.c', 'ext/ima/ima/src/update_t_RY.c', 'ext/ima/ima/src/freemem.c', 'ext/ima/ima/src/autoc.c', 'ext/ima/ima/src/popmig.c', 'ext/ima/ima/src/gtint.c', 'ext/ima/ima/src/histograms.c', 'ext/ima/ima/src/utilities.c', 'ext/ima/ima/src/updateassignment.c', 'ext/ima/ima/src/imagsl.c'],
