...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__IMa

#else
#  define SWIG_init    init_IMa

#endif
#define SWIG_name    "_IMa"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_run_main(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:run_main",&obj0)) SWIG_fail;
  {
    /* Check if is a list */
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"run_main", _wrap_run_main, METH_VARARGS, NULL},
